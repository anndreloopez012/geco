...
<?php
    ...
    $windowHome = '../../home.php';
    $NIUMENU = 7;
    $title = 'Gestion De Cobros - PrinCons';
    $return = 'index.php';
    ...
    require_once '../../api/gestion/admPrinCons.php';

    require_once '../dependenciasHead.php';
    
    require_once '../../api/gestion/admPrinConsAJAX.php';
    ...
    require_once '../../layout/gestion/prinConsComponent.php';
