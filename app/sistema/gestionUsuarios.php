...
<?php
    ...
    $windowHome = '../../home.php';
    $NIUMENU = 8;
    $title = 'Gestion de Usuarios Global';
    $return = 'index.php';
    ...
    require_once '../../api/sistema/admGestionUsuarios.php';

    require_once '../dependenciasHead.php';
    
    require_once '../../api/sistema/admGestionUsuariosAJAX.php';
    ...
    require_once '../../layout/sistema/gestionUsuariosComponente.php';
