...
$rt =  isset($_GET["rt"]) ? $_GET["rt"]  : '';
    ...
    require_once '../../api/actualizaciones/admUpdateSaldos.php';

    require_once '../dependenciasHead.php';

    require_once '../../api/varrGlobal.php';

    require_once '../../api/actualizaciones/admUpdateSaldosAJAX.php';
    ...
    require_once '../../layout/actualizaciones/updateSaldosComponent.php';
