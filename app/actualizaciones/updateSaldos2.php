...
$rt =  isset($_GET["rt"]) ? $_GET["rt"]  : '';
    ...
    $windowHome = '../../home.php';
    $NIUMENU = 4;
    $title = 'ACTUALIZAR SALDOS TIPO 2';
    $return = 'index.php';
    ...
    require_once '../../api/actualizaciones/amdUpdateSaldos2.php';

    require_once '../dependenciasHead.php';

    require_once '../../api/varrGlobal.php';

    require_once '../../api/actualizaciones/amdUpdateSaldos2AJAX.php';
    ...
    require_once '../../layout/actualizaciones/updateSaldos2Component.php';
