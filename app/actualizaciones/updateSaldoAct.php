...
$rt =  isset($_GET["rt"]) ? $_GET["rt"]  : '';
    ...
    require_once '../../api/actualizaciones/amdUpdateSaldoAct.php';

    require_once '../dependenciasHead.php';

    require_once '../../api/varrGlobal.php';

    require_once '../../api/actualizaciones/amdUpdateSaldoActAJAX.php';
    ...
    require_once '../../layout/actualizaciones/updateSaldoActComponent.php';
