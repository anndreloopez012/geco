...
$rt =  isset($_GET["rt"]) ? $_GET["rt"]  : '';
    ...
    $windowHome = '../../home.php';
    $NIUMENU = 4;
    $title = 'ACTUALIZAR PAGOS POR CONFIRMAR';
    $return = 'index.php';
    ...
    require_once '../../api/actualizaciones/admUpdatePagosConf.php';

    require_once '../dependenciasHead.php';

    require_once '../../api/varrGlobal.php';

    require_once '../../api/actualizaciones/admUpdatePagosConfAJAX.php';
    ...
    require_once '../../layout/actualizaciones/updatePagosConfComponent.php';
