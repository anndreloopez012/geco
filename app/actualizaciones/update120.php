...
$rt =  isset($_GET["rt"]) ? $_GET["rt"]  : '';
    ...
    require_once '../../api/actualizaciones/admUpdate120.php';

    require_once '../dependenciasHead.php';

    require_once '../../api/varrGlobal.php';

    require_once '../../api/actualizaciones/admUpdate120AJAX.php';
    ...
    require_once '../../layout/actualizaciones/update120Component.php';
