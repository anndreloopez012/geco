...
$rt =  isset($_GET["rt"]) ? $_GET["rt"]  : '';
    ...
    require_once '../../api/actualizaciones/admUpdateSaldoRevision.php';

    require_once '../dependenciasHead.php';

    require_once '../../api/varrGlobal.php';

    require_once '../../api/actualizaciones/admUpdateSaldoRevisionAJAX.php';
    ...
    require_once '../../layout/actualizaciones/updateSaldoRevisionComponent.php';
