...
$rt =  isset($_GET["rt"]) ? $_GET["rt"]  : '';
    ...
    require_once '../../api/actualizaciones/admUpdateVarios.php';

    require_once '../dependenciasHead.php';

    require_once '../../api/varrGlobal.php';

    require_once '../../api/actualizaciones/admUpdateVariosAJAX.php';
    ...
    require_once '../../layout/actualizaciones/updateVariosComponent.php';
