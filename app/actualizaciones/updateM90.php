...
$rt =  isset($_GET["rt"]) ? $_GET["rt"]  : '';
    ...
    require_once '../../api/actualizaciones/admUpdateM90.php';

    require_once '../dependenciasHead.php';

    require_once '../../api/varrGlobal.php';

    require_once '../../api/actualizaciones/admUpdateM90AJAX.php';
    ...
    require_once '../../layout/actualizaciones/updateM90Component.php';
