...
$rt =  isset($_GET["rt"]) ? $_GET["rt"]  : '';
    ...
    $windowHome = '../../home.php';
    $NIUMENU = 4;
    $title = 'IMPORTACION DE TELEFONOS';
    $return = 'index.php';
    ...
    require_once '../../api/importaciones/admImportacionTelefonos.php';

    require_once '../dependenciasHead.php';

    require_once '../../api/varrGlobal.php';

    require_once '../../api/importaciones/admImportacionTelefonosAJAX.php';
    ...
    require_once '../../layout/importaciones/importacionTelefonosComponent.php';
