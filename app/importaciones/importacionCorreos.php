...
$rt =  isset($_GET["rt"]) ? $_GET["rt"]  : '';
    ...
    require_once '../../api/importaciones/admImportacionCorreos.php';

    require_once '../dependenciasHead.php';

    require_once '../../api/varrGlobal.php';

    require_once '../../api/importaciones/admImportacionCorreosAJAX.php';
    ...
    require_once '../../layout/importaciones/importacionCorreosComponent.php';
