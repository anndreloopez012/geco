...
$rt =  isset($_GET["rt"]) ? $_GET["rt"]  : '';
    ...
    require_once '../../api/importaciones/admImportacionInformacion.php';

    require_once '../dependenciasHead.php';

    require_once '../../api/varrGlobal.php';

    require_once '../../api/importaciones/admImportacionInformacionAJAX.php';
    ...
    require_once '../../layout/importaciones/importacionInformacionComponent.php';
