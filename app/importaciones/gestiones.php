...
<?php
    ...
    $windowHome = '../../home.php';
    $NIUMENU = 4;
    $title = 'IMPORTACION DE GESTIONES';
    $return = 'index.php';
   ...
   // require_once '../../api/varrGlobal.php';
    ...
    require_once '../../api/importaciones/admGestiones.php';

    require_once '../dependenciasHead.php';
    
    require_once '../../api/importaciones/admGestionesAJAX.php';
    ...
    require_once '../../layout//importaciones/gestionesComponent.php';
