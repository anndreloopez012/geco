...
<?php
    ...
    require_once '../../api/supervision/admGeneracionCampanas.php';

    require_once '../dependenciasHead.php';
    
    require_once '../../api/supervision/admGeneracionCampanasAJAX.php';
    ...
    require_once '../../layout/supervision/generacionCampanasComponent.php';
