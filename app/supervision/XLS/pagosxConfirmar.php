...
<?php
    ...
    require_once '../../../api/supervision/admPagosxConfirmar.php';

    require_once 'dependenciasHead.php';
    
    require_once '../../../api/supervision/admPagosxConfirmarAJAX.php';
    ...
    require_once '../../../layout/supervision/pagosxConfirmarComponente.php';
