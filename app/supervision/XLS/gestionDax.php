...
$stmt = "SELECT C.CODIEMPR, C.CODICLIE, C.TELEFONO, C.CLAPROD, C.NOMBRE, C.DIREC, C.MUNI, C.DEPTO, C.FASIG, C.SALDO, C.SALDOVEQ, C.PAGOMINQ,C.CAPATRAS, C.TOTATRAS, C.SALDOD, C.SALDOVED, C.PAGOMIND, C.PAGOS, C.PAGOSD, C.SALDOACT, C.SALDOACD, C.CICLOVEQ, G.TIPOLOGI, G.CONCLUSI, G.SUBCONCL,G.RTESTADO, G.FGESTION, SUBSTRING(G.HORA FROM 1 FOR 8) AS HORA, G.NIU, G.OBSERVAC, C.CANTGEST, C.GESTORD, G.OWNER, C.EXPEDIEN, C.NUMTRANS, G.FECHAPP1, G.MONTOPP
        ...
        $strFilter33G
        $strFilter44G
        ORDER BY C.NOMBRE, C.CLAPROD, G.FGESTION DESCENDING, G.HORA DESCENDING";
//print_r($stmt);
//die();
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
