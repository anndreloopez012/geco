...
<?php
    ...
    require_once '../../api/supervision/admRevision.php';

    require_once '../dependenciasHead.php';
    
    require_once '../../api/supervision/admRevisionAJAX.php';
    ...
    require_once '../../layout/supervision/revisionComponent.php';
