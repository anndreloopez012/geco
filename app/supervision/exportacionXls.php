...
<?php
    ...
    require_once '../../api/supervision/admExportacionXls.php';

    require_once '../dependenciasHead.php';
    
    require_once '../../api/supervision/admExportacionXlsAJAX.php';
    ...
    require_once '../../layout/supervision/exportacionXlsComponente.php';
