...
$rt =  isset($_GET["rt"]) ? $_GET["rt"]  : '';
    ...
    require_once '../../api/distribucion/admReasignacion.php';

    require_once '../dependenciasHead.php';

    require_once '../../api/varrGlobal.php';

    require_once '../../api/distribucion/admReasignacionAJAX.php';
    ...
    require_once '../../layout/distribucion/reasignacionComponent.php';
