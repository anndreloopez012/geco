...
$rt =  isset($_GET["rt"]) ? $_GET["rt"]  : '';
    ...
    require_once '../../api/distribucion/admAsignacion.php';

    require_once '../dependenciasHead.php';

    require_once '../../api/varrGlobal.php';

    require_once '../../api/distribucion/admAsignacionAJAX.php';
    ...
    require_once '../../layout/distribucion/asignacionComponent.php';
