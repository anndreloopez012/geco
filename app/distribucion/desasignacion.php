...
$rt =  isset($_GET["rt"]) ? $_GET["rt"]  : '';
    ...
    require_once '../../api/distribucion/admDesasignacion.php';

    require_once '../dependenciasHead.php';

    require_once '../../api/varrGlobal.php';

    require_once '../../api/distribucion/admDesasignacionAJAX.php';
    ...
    require_once '../../layout/distribucion/desasignacionComponent.php';
