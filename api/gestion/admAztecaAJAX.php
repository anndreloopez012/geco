<script>
    ...
    function fntInsertGlobal() {
        ...
        $.ajax({
            ...
            data: datos,
            dataType: 'json',
            url: "azteca.php?ajax=true&validaciones=insert_gestion_",
            success: function(r) {
                if (r.status) {
                    if (r.status == 2) {
    ...
    function fntDibujoFrontAzteca() {

        var strgt = $("#gt").val();
        var strnumView = $("#numView").val();
        var strnumOnmy = $("#numOnmy").val();
        var strnomAzteca = $("#nomAzteca").val();
        var stridNomAzteca = $("#idNomAzteca").val();
        var strfecha = $("#fechaAzteca").val();

        var strpais_az = $("#pais_az").val();
        var strcanal_az= $("#canal_az").val();
        var strsuc_az = $("#suc_az").val();
        var strfolio_az = $("#folio_az").val();
        var strid_camp_az = $("#id_camp_az").val();

        document.getElementById("loading-screen").style.display = "block";

        $.ajax({

            url: "azteca.php?validaciones=encrypt_azteca",
            data: {
                gt: strgt,
                numView: strnumView,
                numOnmy: strnumOnmy,
                nomAzteca: strnomAzteca,
                idNomAzteca: stridNomAzteca,
                fecha: strfecha,

                pais_az: strpais_az,
                canal_az: strcanal_az,
                suc_az: strsuc_az,
                folio_az: strfolio_az,
                id_camp_az: strid_camp_az,
            },
            async: true,
            global: false,
            type: "post",
            ...
            success: function(data) {
                ...
                $("#TablaModalAzteca").html("");
                $("#TablaModalAzteca").html(data);

                document.getElementById("loading-screen").style.display = "none";
                document.getElementById("paginaAzteca").click();
                $('#telefonos').modal('hide')
                //$('#modalAzteca').modal('show')
                //document.getElementById('modalAzteca_').style.display = 'inline';
    ...
    function fntInsertIniWindowTrabajo() {
        ...
        $.ajax({
            ...
            data: datos,
            dataType: 'json',
            url: "azteca.php?ajax=true&validaciones=insert_ini_window_trabajo",
            success: function(r) {
                if (r.status) {
                    if (r.status == 1) {
                        fntInsertGlobal()
    ...
    function fntInsertIniWindow() {
        ...
        $.ajax({
            ...
            data: datos,
            dataType: 'json',
            url: "azteca.php?ajax=true&validaciones=insert_ini_window",
            success: function(r) {
                if (r.status) {
                    if (r.status == 1) {
                        //  alertify.set('notifier', 'position', 'top-center');
    ...
    function fntInsertEndWindow() {
        ...
        $.ajax({
            ...
            data: datos,
            dataType: 'json',
            url: "azteca.php?ajax=true&validaciones=insert_end_window",
            success: function(r) {
                if (r.status) {
                    if (r.status == 1) {
                        //  alertify.set('notifier', 'position', 'top-center');
    ...
    function fntInsertTelefono() {
        ...
        $.ajax({
            ...
            data: datos,
            dataType: 'json',
            url: "azteca.php?ajax=true&validaciones=insert_telefono",
            success: function(r) {
                if (r.status) {
                    if (r.status == 1) {
    ...
    function fntUpdateTelefono() {
        ...
        $.ajax({
            ...
            data: datos,
            dataType: 'json',
            url: "azteca.php?ajax=true&validaciones=update_telefono",
            success: function(r) {
                if (r.status) {
                    if (r.status == 1) {
    ...
    function fntUpdateActiveTelefonoBoton() {
        ...
        $.ajax({
            ...
            data: datos,
            dataType: 'json',
            url: "azteca.php?ajax=true&validaciones=update_telefono_boton",
            success: function(r) {
                if (r.status) {
                    if (r.status == 1) {
                        fntDibujoTablaTelefonos()
    ...
    function fntInsertDireccion() {
        ...
        $.ajax({
            ...
            data: datos,
            dataType: 'json',
            url: "azteca.php?ajax=true&validaciones=insert_direccion",
            success: function(r) {
                if (r.status) {
                    if (r.status == 1) {
    ...
    function fntInsertCorreo() {
        ...
        $.ajax({
            ...
            data: datos,
            dataType: 'json',
            url: "azteca.php?ajax=true&validaciones=insert_correo",
            success: function(r) {
                if (r.status) {
                    if (r.status == 1) {
    ...
    function fntUpdateActiveInfoDireccion() {
        ...
        $.ajax({
            ...
            data: datos,
            dataType: 'json',
            url: "azteca.php?ajax=true&validaciones=update_direccion_mas_informacion",
            success: function(r) {
                if (r.status) {
                    if (r.status == 1) {
    ...
    function fntUpdateActiveExpedien() {
        ...
        $.ajax({
            ...
            data: datos,
            dataType: 'json',
            url: "azteca.php?ajax=true&validaciones=update_expediente",
            success: function(r) {
                if (r.status) {
                    if (r.status == 1) {
                        alertify.set('notifier', 'position', 'top-center');
    ...
    function fntUpdateActiveInfoCorreos() {
        ...
        $.ajax({
            ...
            data: datos,
            dataType: 'json',
            url: "azteca.php?ajax=true&validaciones=update_correo_informacion",
            success: function(r) {
                if (r.status) {
                    if (r.status == 1) {
                        fntDibujoInfoCorreo()
    ...
    function fntDibujoTablaGestionMovimiento() {
        ...
        $.ajax({
            ...
            url: "azteca.php?validaciones=tabla_movimiento_gestion",
            data: {
    ...
    function fntDibujoTiemposEmpresa() {
        ...
        $.ajax({
            ...
            url: "azteca.php?validaciones=var_tiempos_empresa",
            data: {
    ...
    function fntDibujoTablaTelefonos() {
        ...
        $.ajax({
            ...
            url: "azteca.php?validaciones=tabla_telefonos",
            data: {
    ...
    function fntDibujoTablaCuentas() {
        ...
        $.ajax({
            ...
            url: "azteca.php?validaciones=tabla_cuentas",
            data: {
    ...
    function fntVarCodigoServicio() {
        ...
        $.ajax({
            ...
            url: "azteca.php?validaciones=var_codigo_servicio",
            data: {
    ...
    function fntDibujoOrigen() {
        ...
        $.ajax({
            ...
            url: "azteca.php?validaciones=tabla_tipologia_origen",
            data: {
    ...
    function fntDibujoPlace() {
        ...
        $.ajax({
            ...
            url: "azteca.php?validaciones=tabla_tipologia_place",
            data: {
    ...
    function fntDibujoReceptor() {
        ...
        $.ajax({
            ...
            url: "azteca.php?validaciones=tabla_tipologia_receptor",
            data: {
    ...
    function fntDibujoTipologia() {
        ...
        $.ajax({
            ...
            url: "azteca.php?validaciones=tabla_tipologia_",
            data: {
    ...
    function fntDibujoRdm() {
        ...
        $.ajax({
            ...
            url: "azteca.php?validaciones=tabla_tipologia_rdm_",
            data: {
    ...
    function fntValidacionInsertTelefono() {
        ...
        if (numero) {
            ...
            $.ajax({
                ...
                url: "azteca.php?validaciones=validacion_insert_telefono&numero=" + numero + "&codiclie_tel=" + codiclie_tel,
                async: true,
                global: false,
                dataType: 'json',
    ...
    function fntUpdateActiveDireccion() {
        ...
        $.ajax({
            ...
            data: datos,
            dataType: 'json',
            url: "azteca.php?ajax=true&validaciones=update_direccion_investiga",
            success: function(r) {
                if (r.status) {
                    if (r.status == 1) {
    ...
    function fntDibujoInvestigaCasos() {
        ...
        $.ajax({
            ...
            url: "azteca.php?validaciones=tabla_sub_menu_investiga_casos",
            data: {
    ...
    function fntDibujoInvestigaFormulario() {
        ...
        $.ajax({
            ...
            url: "azteca.php?validaciones=tabla_sub_menu_investiga_formulario",
            data: {
    ...
    function fntDibujoInvestigaTelefono() {
        ...
        $.ajax({
            ...
            url: "azteca.php?validaciones=tabla_sub_menu_investiga_telefonos",
            data: {
    ...
    function fntDibujoInvestigaDireccion() {
        ...
        $.ajax({
            ...
            url: "azteca.php?validaciones=tabla_sub_menu_investiga_direcciones",
            data: {
                investiga_codiclie: stRinvestiga_codiclie,
            },
            async: true,
    ...
    function fntDibujoInvestigaCorreo() {
        ...
        $.ajax({
            ...
            url: "azteca.php?validaciones=tabla_sub_menu_investiga_correos",
            data: {
                investiga_codiclie: stRinvestiga_codiclie,
            },
            async: true,
    ...
    function fntDibujoInfoDirecciones() {
        ...
        $.ajax({
            ...
            url: "azteca.php?validaciones=tabla_sub_menu_informacion_direcciones",
            data: {
    ...
    function fntDibujoInfoCorreo() {
        ...
        $.ajax({
            ...
            url: "azteca.php?validaciones=tabla_sub_menu_informacion_correos",
            data: {
    ...
    function fntDibujoEstadoDeCuenta() {
        ...
        $.ajax({
            ...
            url: "azteca.php?validaciones=tabla_estado_de_cuenta",
            data: {
                numCasoPdf: stRnumCasoPdf,
            },
            async: true,
    ...
    function fntDibujoDocumentosDigitales() {
        ...
        $.ajax({
            ...
            url: "azteca.php?validaciones=tabla_documentos_digitales",
            data: {
