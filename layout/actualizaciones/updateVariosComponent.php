                                ...
                                <div class="collapsed-card">
                                    <div class="card-body ">
                                        <div class="row col-12">
                                            ...
                                            <div class="form-group row col-sm-12">
                                                <label>Seleccion de Plantilla </label>&nbsp
                                                <div class="form-group col-1 row">
                                                    <input type="text" class="form-control" id="CodePlantilla" name="CodePlantilla">
                                                </div>
                                                <div id="dropdown_plantilla" class="form-group col-sm-8 row" name="dropdown_plantilla">
                                                    <!-- DIBUJO DE DROPDOWN EMPRESA -->
                                                </div>
                                            </div>
...
function fntSelectViewPlantiila(intParametro) {
    ...
    function fntSelectPlantiila(intParametro) {
        intParametro = !intParametro ? 0 : intParametro;

        if (intParametro > 0) {
            var strSupervisor = $("#hid_plan_" + intParametro).val();
            // alert(strDPI + "                         strDPI");
